    ...
    <PageShell>
      ...
      <Prose>
        ...
        <p>
          ...
          that infringes your rights, send a DMCA notice to <a href="mailto:dmca@pingrab.click">dmca@pingrab.click</a>
        ...
        <h2>11. Contact</h2>
        <p>
          Questions about these Terms: <a href="mailto:legal@pingrab.click">legal@pingrab.click</a>
        </p>
      </Prose>
    </PageShell>
  );
