...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pingrab.app/privacy' },
    ...
    <PageShell>
      ...
      <Prose>
        <p>
          ...
          when you use <strong>pingrab.app</strong> and the PinGrab browser extension (collectively the
        ...
        <p>
          ...
          advertising consent. Contact <a href="mailto:privacy@pingrab.app">privacy@pingrab.app</a> to exercise
        ...
        <h2>11. Contact</h2>
        <p>
          Privacy questions: <a href="mailto:privacy@pingrab.app">privacy@pingrab.app</a>
        </p>
      </Prose>
    </PageShell>
  );
