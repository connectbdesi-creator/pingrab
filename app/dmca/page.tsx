...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pingrab.app/dmca' }
};
  ...
  return (
    <PageShell>
      ...
      <Prose>
        ...
        <p>
          Email <a href="mailto:dmca@pingrab.app">dmca@pingrab.app</a> with the following information:
        </p>
        <ol>
        ...
        <p>
          ...
          <a href="mailto:dmca@pingrab.app">dmca@pingrab.app</a> containing your contact information, the URL
